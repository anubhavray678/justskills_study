...
function TermsAndCons() {
  return (
    <div>
      ...
      <p>Welcome to Justskills!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Justskills &apos;s Website, located at{" "}
        <span className="text-purple-400">https://justskills.in</span>.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Justskills if you do not agree to
        take all of the terms and conditions stated on this page.
      </p>

      <p>
        The following terminology applies to these Terms and Conditions, Privacy
        Statement and Disclaimer Notice and all Agreements: &ldquo;Client
        &ldquo;, &ldquo;You&ldquo; and &ldquo;Your&ldquo; refers to you, the
        person log on this website and compliant to the Company &apos;s terms
        and conditions. &ldquo;The Company&ldquo;, &ldquo;Ourselves&ldquo;,
        &ldquo;We&ldquo;, &ldquo;Our&ldquo; and &ldquo;Us&ldquo;, refers to our
        Company. &ldquo;Party&ldquo;, &ldquo;Parties&ldquo;, or
        &ldquo;Us&ldquo;, refers to both the Client and ourselves. All terms
      ...
      <p>
        We employ the use of cookies. By accessing Justskills, you agreed to use
        cookies in agreement with the Justskills &apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Justskills and/or its licensors own the
        intellectual property rights for all material on Justskills. All
        intellectual property rights are reserved. You may access this from
        Justskills for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Justskills</li>
        <li>Sell, rent or sub-license material from Justskills</li>
        <li>Reproduce, duplicate or copy material from Justskills</li>
        <li>Redistribute content from Justskills</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Justskills does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Justskills,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Justskills shall not be
      ...
      <p>
        Justskills reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Justskills a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Justskills; and (d) the link is
      ...
      <p>
        ...
        e-mail to Justskills. Please include your name, your organization name,
      ...
      <p>
        No use of Justskills &apos;s logo or other artwork will be allowed for
