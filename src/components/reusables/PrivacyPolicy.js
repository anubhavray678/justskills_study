...
function PrivacyPolicy() {
  return (
    <div>
      ...
      <br />
      <h2 className="text-gray-900">Interpretation and Definitions</h2>
      <br />
      <h3 className="text-gray-900">Interpretation</h3>
      <br />
      <p>
      ...
      <br />
      <h3 className="text-gray-900">Definitions</h3>
      <br />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Justskills.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <br /> <strong>Personal Data</strong> is any information that
        ...
        <li>
          <p>
            <br /> <strong>Website</strong> refers to Justskills, accessible
            from{" "}
            <a
              href="https://www.justskills.in"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.justskills.in
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>
            <span className="text-gray-900">By email:</span>
            <span className="text-purple-500">contact.justskill@gmail.com</span>
          </p>
        </li>
        <li>
          <p className="text-gray-900">
            ...
            <a
              href="https://www.justskills.in/contact"
              rel="external nofollow noopener"
              target="_blank"
              className="text-purple-500"
            >
              https://www.justskills.in/contact
            </a>
          </p>
        </li>
      </ul>
