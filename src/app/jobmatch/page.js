...
export default function ResumeMatcher() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      // Update your UI or state with the response data
      setResult({
  ...
  return (
    <>
      <head>
        <title>Justskills - JobMatcher</title>
        <meta property="og:title" content="JobMatcher" />
        <meta
          property="og:description"
          content="Justskills resume checker will help you build or optimize your resume for a specific job listing so that you get more interviews."
        />
        <meta property="og:image" content="./placement.png" />

        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="./placement.png" />
      </head>
        ...
        <div className="relative bg-gradient-to-br from-green-100 to-red-200 flex justify-around items-center p-8 h-full overflow-hidden flex-col md:flex-row md:h-[80vh] gap-10">
          ...
          <div className="relative z-10 text-center text-white bg-gradient-to-br from-indigo-700 to-purple-800 p-12 rounded-3xl shadow-2xl max-w-md mx-4">
            ...
            <p className="text-lg mb-8 text-gray-200">
              Justskills helps you tailor your resume for any job by
              highlighting the key experiences and skills that recruiters value
              most.
            </p>
            <button
